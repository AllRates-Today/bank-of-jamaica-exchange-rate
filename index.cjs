'use strict';
// Bank of Jamaica exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/bojm';
...
/** Latest rate for one pair, e.g. getRate('USD', 'JMD', { apiKey }). */
