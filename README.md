# Bank of Jamaica Exchange Rate API — bank-of-jamaica-exchange-rate
...
Also published under the org scope as [`@allratestoday/bank-of-jamaica-exchange-rate`](https://www.npmjs.com/package/@allratestoday/bank-of-jamaica-exchange-rate) — same code, same versions.
...
```javascript
{
  ...
  rate_date: '2026-08-24',   // Bank of Jamaica's own publication date
  source: 'USD',
  target: 'JMD',
  rate: 159.3918,
  rate_type: 'sell',
...
```javascript
{
  ...
  rates: [
    { "base": "USD", "quote": "JMD", "type": "sell", "value": 159.3918 },
    { "base": "USD", "quote": "JMD", "type": "buy", "value": 157.8412 },
...
const series = await getHistory(
  { source: 'USD', target: 'JMD', from: '2026-01-01', to: '2026-08-24' },
  { apiKey: 'art_live_...' }
);
```
...
```javascript
{
  ...
  rates: [
    ...
    { date: '2026-08-24', rate: 159.3918, rate_type: 'sell', derived: false, method: 'published' },
    // …
  ],
  disclaimer: '…'
}
